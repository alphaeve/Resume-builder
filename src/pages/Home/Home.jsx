...
const Home = () => {
    ...
    const handleSelectTemplate = (templateId) => {
        // Store the selected template in localStorage or state management (Redux)
    ...
    return (
        <div className="container1">
            <Typography variant="h4" gutterBottom>
                Hi, I am <span style={{ color: 'teal' }}>Dhruvil</span>.
            ...
            <Grid container spacing={3}>
                {resumeTemplates.map((template) => (
                    <Grid item xs={12} sm={6} md={4} key={template.id}>
                        <div className="template1" onClick={() => handleSelectTemplate(template.id)}>
                            ...
                            <div className="template-content1">
                                ...
                                <Button onClick={() => handleSelectTemplate(template.id)} variant="contained" color="primary" className="select-button1">
    Select Template
</Button>
                            </div>
                        </div>
